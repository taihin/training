package com.wdtraining.pageobject.pageObjects;
...
public class AanmeldenNieuwsbriefPage {
	...
	private WebElement errMessageWithoutEmail;
	...
	public String GetErrMsgNoEmailAddress() {
		return errMessageWithoutEmail.getText();
	}
